...
<main id="sign-up">
    ...
    <form action="/sign-up" method="post">
        <ul class="inputs">
            ...
            <li class="captcha">
                ...
                <div class="container">
                    <canvas></canvas>
                    <div class="container">
                        <button id="reload" type="button">다시</button>
                        <button id="voice" type="button">보이스</button>
                    </div>
                </div>
                <input type="text">
            </li>
        ...
        <div class="buttons">
            ...
            <li id="already-account">
                <a href="/sign-in">Already have an account?</a>
            </li>
        </div>
    </form>
</main>
<script src="public/script/SignUp.js" type="module"></script>